...
```{r}
# STOCK PRICES
sp_500_prices_tbl <- read_rds("C:/Users/navan/OneDrive/Desktop/BM/BDML/Machine Learning Fundamentals Data/sp_500_prices_tbl.rds")
sp_500_prices_tbl
```
...
```{r}
# SECTOR INFORMATION
sp_500_index_tbl <- read_rds("C:/Users/navan/OneDrive/Desktop/BM/BDML/Machine Learning Fundamentals Data/sp_500_index_tbl.rds")
sp_500_index_tbl
```
...
## Step 1 - Conversion of stock prices to a standardized format
...
## Step 2 - Conversion to User-Item Format
...
```{r}
sp_500_daily_returns_tbl <- read_rds("C:/Users/navan/OneDrive/Desktop/BM/BDML/Machine Learning Fundamentals Data/sp_500_daily_returns_tbl.rds")
sp_500_daily_returns_tbl
```
...
We're going to import the correct results first (just in case you were not able to complete the last step).
```{r}
stock_date_matrix_tbl <- read_rds("C:/Users/navan/OneDrive/Desktop/BM/BDML/Machine Learning Fundamentals Data/stock_date_matrix_tbl.rds")
```
...
## Step 4 - Finding the optimal value of K
...
We're going to import the correct results first (just in case you were not able to complete the last step).
```{r}
k_means_mapped_tbl <- read_rds("C:/Users/navan/OneDrive/Desktop/BM/BDML/Machine Learning Fundamentals Data/k_means_mapped_tbl.rds")
```
...
```{r}
# Conversion of umap results to tibble with symbols
...
## Step 6 - Combining K-Means and UMAP
...
```{r}
k_means_mapped_tbl <- read_rds("C:/Users/navan/OneDrive/Desktop/BM/BDML/Machine Learning Fundamentals Data/k_means_mapped_tbl.rds")
umap_results_tbl   <- read_rds("C:/Users/navan/OneDrive/Desktop/BM/BDML/Machine Learning Fundamentals Data/umap_results_tbl.rds")
```
...
```{r}
# Using dplyr & broom to combine the k_means_obj with the umap_results_tbl
