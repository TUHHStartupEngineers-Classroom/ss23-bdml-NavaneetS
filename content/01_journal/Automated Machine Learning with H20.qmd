...
library(sjlabelled)
library(stringr)
employee_attrition_tbl <- read.csv("C:/Users/navan/OneDrive/Desktop/BM/BDML/Machine Learning Fundamentals Data/WA_Fn-UseC_-HR-Employee-Attrition.csv")
...
## Compensation features: HourlyRate, Monthly Income, Stock Option Level
...
* <mark>(a)Those that are leaving have a lower density of 3's and 4's
...
* <mark>(a)The proportion of those leaving that are working Over Time are high compared to those that are not leaving
...
* <mark>(a)People that leave tend to have more annual trainings
...
* <mark>(b)People that leave tend to have less working years at the company
* (c)It's difficult to deduce anything based on the visualization

### Q10.What can you deduce about the interaction between Years Since Last Promotion and Attrition?

* <mark>(a)Those that are leaving have more years since last promotion than those that are staying
